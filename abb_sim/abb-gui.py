...
try: # Expect files in working directory
    ...
    link7 = AsciiSTL(filename="cad/link7.ast")
    ...
    print(detail)
    raise SystemExit("abb-gui requires files link[1-7].ast in working directory")
